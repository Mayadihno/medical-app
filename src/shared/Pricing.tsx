    ...
    const plans = [
        ...
        },
        {
            ...
            features: [
                ...
                "Integration with electronics health care record (EHC) systems",
                                    ...
                                    <div className="flex">
                                        ...
                                        <TooltipProvider>
                                            <Tooltip>
                                                ...
                                                <TooltipContent className=' bg-slate-900 text-xs text-white'>
                                                    <p>Palpay/strip will charge their regular transaction fee</p>
                                                </TooltipContent>
                                            </Tooltip>
                                        </TooltipProvider>
